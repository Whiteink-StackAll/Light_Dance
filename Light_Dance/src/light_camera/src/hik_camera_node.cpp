...
namespace light_camera {
class HikCameraNode : public rclcpp::Node {
public:
    explicit HikCameraNode(const rclcpp::NodeOptions &options) : Node("light_camera", options) {
...
RCLCPP_COMPONENTS_REGISTER_NODE(light_camera::HikCameraNode)
